...
const castles = [
  ...
  {
    name: "Ritter-Hüpfburg",
    description: "Für kleine Ritter und Burgfräulein - erobere die Burg und verteidige das Königreich!",
    size: "6,5x4,2m",
    age: "3-12 Jahre",
          ...
          {castles.map((castle, index) => (
            <Card key={index} className="overflow-hidden hover:shadow-xl transition-shadow flex flex-col h-full !pt-0 !gap-0">
              <div className="relative h-72">
                <img src={castle.image || "/placeholder.svg"} alt={castle.name} className="w-full h-full object-cover" />
              </div>
