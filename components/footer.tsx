    ...
    <footer className="bg-muted/50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Ihr zuverlässiger Partner für unvergessliche Events mit erlebnisreichen Hüpfburgen.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/huepfgenuss?igsh=NG1na2wwOXFlZ3Vt" className="text-muted-foreground hover:text-primary transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a
                href="mailto:huepfgenuss@outlook.de"
        ...
        <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p className="mb-2">&copy; {new Date().getFullYear()} Hüpfgenuss. Alle Rechte vorbehalten.</p>
          <p className="text-xs">
